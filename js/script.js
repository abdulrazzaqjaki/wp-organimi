...
class Slider {
    ...
    get_price_html(first, str, str1){
        ...
        let html = `<span><span class="plan-price">$`+first+`</span><small>/`+str+`</small></span><br><span><small>paid `+str1+`</small></span>`;
        return html;
    }
    ...
    updateSlider (newValue) {
        ...
        let og_10_message = "Contact us for a quote";
        ...
        if(this_value <= 11){
            ...
            basic_first = basic_package.per_month;
            premium_first = premium_package.per_month;
